...
public class Improve extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Backgroundpage.jpg"))); // NOI18N
        jLabel2.setText("jLabel2");

        jTextField1.setBackground(new java.awt.Color(204, 204, 204));
        jTextField1.setFont(new java.awt.Font("Segoe UI", 3, 24)); // NOI18N
        jTextField1.setText("                         IMPROVE YOUR VOCABULARY");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Improve.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
